...
var TextString = function TextString(_ref) {
  ...
  React.useLayoutEffect(function () {
    var desiredTextContent = isTrailing ? text + '\n' : text;

    if (ref.current != null && ref.current.textContent !== desiredTextContent) {
      ref.current.textContent = desiredTextContent;
    }
  });
