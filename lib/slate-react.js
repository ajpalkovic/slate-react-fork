...
var Leaf = function Leaf(props) {
  ...
  if (editor.query('isVoid', parent)) {
    ...
    children = React__default.createElement(TextString, { zeroWidth: true, length: parent.text.length });
  } else if (text === '' && parent.object === 'block' && parent.text === '' && parent.nodes.last() === node) {
    // COMPAT: If this is the last text node in an empty block, render a zero-
    // width space that will convert into a line break when copying and pasting
    // to support expected plain text.
    children = React__default.createElement(TextString, { zeroWidth: true, isLineBreak: true });
  } else if (text === '') {
    // COMPAT: If the text is empty, it's because it's on the edge of an inline
    // node, so we render a zero-width space so that the selection can be
    // inserted next to it still.
    children = React__default.createElement(TextString, { zeroWidth: true });
  } else {
...
var Text = React__default.forwardRef(function (props, ref) {
  ...
  return React__default.createElement(
    ...
    leaves.map(function (leaf, index) {
      ...
      return React__default.createElement(MemoizedLeaf, {
        key: node.key + '-' + index,
        block: block,
        editor: editor,
        index: index,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderText = function () {
    ...
    return React__default.createElement(MemoizedText, {
      ref: textRef,
      annotations: annotations,
...
var Node = function (_React$Component) {
  ...
  createClass(Node, [{
    ...
    value: function render() {
      ...
      return editor.isVoid(node) ? React__default.createElement(
        Void,
        _extends({}, this.props, {
...
var Content = function (_React$Component) {
  ...
  function Content() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Content.__proto__ || Object.getPrototypeOf(Content)).call.apply(_ref, [this].concat(args))), _this), _this.tmp = {
      ...
      nodeRef: React__default.createRef(),
      nodeRefs: {},
      contentKey: 0,
    ...
    }, _this.ref = React__default.createRef(), _this.setRef = function (el) {
...
function BeforePlugin() {
  ...
  function flushQueuedNativeOperations(editor) {
    ...
    var selection = nextNativeOperation.selection,
    ...
    editor.select(slate.Range.create({
      anchor: { path: path, key: key, offset: currentOffset },
      focus: { path: path, key: key, offset: currentOffset }
    }));
...
var Editor = function (_React$Component) {
  ...
  function Editor() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Editor.__proto__ || Object.getPrototypeOf(Editor)).call.apply(_ref, [this].concat(args))), _this), _this.state = { value: _this.props.defaultValue, contentKey: 0
      ...
      resolves: 0,
      updates: 0,
      contentRef: React__default.createRef()
  ...
  createClass(Editor, [{
    ...
    value: function render() {
      ...
      var children = React__default.createElement(Content, _extends({}, domProps, {
