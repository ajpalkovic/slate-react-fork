...
function BeforePlugin() {
  ...
  function onBeforeInput(event, editor, next) {
    console.log('!!  onBeforeInput with data:' + JSON.stringify(event.data) + ' inputType:' + event.inputType + ' has2:' + slateDevEnvironment.HAS_INPUT_EVENTS_LEVEL_2 + ' isSynthetic:' + !!event.nativeEvent);
  ...
  function syncDomToSlateAst(editor) {
    ...
    console.log('    textNode: ' + JSON.stringify(textNode.textContent) + ' ' + textNode.textContent.length);
    console.log('    slateDomSpan: ' + JSON.stringify(slateDomSpan.textContent) + ' ' + slateDomSpan.textContent.length);
    console.log('    slateAstNode: ' + JSON.stringify(slateAstNode.text) + ' ' + slateAstNode.text.length);
